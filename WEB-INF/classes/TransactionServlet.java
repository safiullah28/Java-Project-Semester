...
//       String deductQuery = "UPDATE accounts SET balance = balance - " +
//       amount +
//                            " WHERE account_number = '" + senderAccount +
//                            "' AND balance >= " + amount;
//       int rs = stmt.executeUpdate(deductQuery);

//       if (rs > 0) {
//         String addQuery = "UPDATE accounts SET balance = balance + " + amount
//         +
//                           " WHERE account_number = '" + receiverAccount +
//                           "'";
//         int rs = stmt.executeUpdate(addQuery);
//         if (rs == 1) {
//           conn.commit();
//           response.sendRedirect(
//               "UserDashboardServlet?message=Transaction successful");
//         }
//       } else {
//         conn.rollback();
//         response.sendRedirect("Transaction.html?error=Insufficient balance");
//       }
//     } catch (Exception e) {
//       e.printStackTrace();
